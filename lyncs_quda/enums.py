...
class QudaLinkType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_links"
    _values = {'su3': 0, 'general': 1, 'three': 2, 'momentum': 3, 'coarse': 4, 'smeared': 5, 'wilson': 0, 'asqtad_fat': 1, 'asqtad_long': 2, 'asqtad_mom': 3, 'asqtad_general': 1, 'invalid': -2147483648}
...
class QudaGaugeFieldOrder(Enum):
    ...
    _values = {'float': 1, 'float2': 2, 'float4': 4, 'float8': 8, 'native': 9, 'qdp': 10, 'qdpjit': 11, 'cps_wilson': 12, 'milc': 13, 'milc_site': 14, 'bqcd': 15, 'tifr': 16, 'tifr_padded': 17, 'invalid': -2147483648}
...
class QudaTboundary(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'anti_periodic_t': -1, 'periodic_t': 1, 'invalid_t_boundary': -2147483648}
...
class QudaPrecision(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_precision"
    _values = {'quarter': 1, 'half': 2, 'single': 4, 'double': 8, 'invalid': -2147483648}
...
class QudaReconstructType(Enum):
    ...
    _suffix = ""
    _values = {'no': 18, '12': 12, '8': 8, '9': 9, '13': 13, '10': 10, 'invalid': -2147483648}
...
class QudaDslashType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_dslash"
    _values = {'wilson': 0, 'clover_wilson': 1, 'clover_hasenbusch_twist': 2, 'domain_wall': 3, 'domain_wall_4d': 4, 'mobius_dwf': 5, 'mobius_dwf_eofa': 6, 'staggered': 7, 'asqtad': 8, 'twisted_mass': 9, 'twisted_clover': 10, 'laplace': 11, 'covdev': 12, 'invalid': -2147483648}
...
class QudaInverterType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_inverter"
    _values = {'cg': 0, 'bicgstab': 1, 'gcr': 2, 'mr': 3, 'sd': 4, 'pcg': 5, 'eigcg': 6, 'inc_eigcg': 7, 'gmresdr': 8, 'gmresdr_proj': 9, 'gmresdr_sh': 10, 'fgmresdr': 11, 'mg': 12, 'bicgstabl': 13, 'cgne': 14, 'cgnr': 15, 'cg3': 16, 'cg3ne': 17, 'cg3nr': 18, 'ca_cg': 19, 'ca_cgne': 20, 'ca_cgnr': 21, 'ca_gcr': 22, 'invalid': -2147483648}
...
class QudaEigType(Enum):
    ...
    _prefix = "quda_eig_"
    _suffix = ""
    _values = {'tr_lanczos': 0, 'blk_tr_lanczos': 1, 'ir_arnoldi': 2, 'blk_ir_arnoldi': 3, 'invalid': -2147483648}
...
class QudaEigSpectrumType(Enum):
    ...
    _suffix = ""
    _values = {'lm_eig': 0, 'sm_eig': 1, 'lr_eig': 2, 'sr_eig': 3, 'li_eig': 4, 'si_eig': 5, 'invalid': -2147483648}
...
class QudaSolutionType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_solution"
    _values = {'mat': 0, 'matdag_mat': 1, 'matpc': 2, 'matpc_dag': 3, 'matpcdag_matpc': 4, 'matpcdag_matpc_shift': 5, 'invalid': -2147483648}
...
class QudaSolveType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_solve"
    _values = {'direct': 0, 'normop': 1, 'direct_pc': 2, 'normop_pc': 3, 'normerr': 4, 'normerr_pc': 5, 'normeq': 1, 'normeq_pc': 3, 'invalid': -2147483648}
...
class QudaMultigridCycleType(Enum):
    ...
    _suffix = ""
    _values = {'vcycle': 0, 'fcycle': 1, 'wcycle': 2, 'recursive': 3, 'invalid': -2147483648}
...
class QudaResidualType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_residual"
    _values = {'l2_relative': 1, 'l2_absolute': 2, 'heavy_quark': 4, 'invalid': -2147483648}
...
class QudaMatPCType(Enum):
    ...
    _prefix = "quda_matpc_"
    _suffix = ""
    _values = {'even_even': 0, 'odd_odd': 1, 'even_even_asymmetric': 2, 'odd_odd_asymmetric': 3, 'invalid': -2147483648}
...
class QudaDiracFieldOrder(Enum):
    ...
    _values = {'internal': 0, '': 1, 'qdp': 2, 'qdpjit': 3, 'cps_wilson': 4, 'lex': 5, 'tifr_padded': 6, 'invalid': -2147483648}
...
class QudaCloverFieldOrder(Enum):
    ...
    _values = {'float': 1, 'float2': 2, 'float4': 4, 'float8': 8, 'packed': 9, 'qdpjit': 10, 'bqcd': 11, 'invalid': -2147483648}
...
class QudaVerbosity(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'silent': 0, 'summarize': 1, 'verbose': 2, 'debug_verbose': 3, 'invalid_verbosity': -2147483648}
...
class QudaFieldOrder(Enum):
    ...
    _values = {'float': 1, 'float2': 2, 'float4': 4, 'float8': 8, 'space_spin_color': 9, 'space_color_spin': 10, 'qdpjit': 11, 'qop_domain_wall': 12, 'padded_space_spin_color': 13, 'invalid': -2147483648}
...
class QudaFieldCreate(Enum):
    ...
    _values = {'null': 0, 'zero': 1, 'copy': 2, 'reference': 3, 'ghost': 4, 'invalid': -2147483648}
...
class QudaSourceType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_source"
    _values = {'point': 0, 'random': 1, 'constant': 2, 'sinusoidal': 3, 'corner': 4, 'invalid': -2147483648}
...
class QudaDilutionType(Enum):
    ...
    _suffix = ""
    _values = {'spin': 0, 'color': 1, 'spin_color': 2, 'spin_color_even_odd': 3, 'invalid': -2147483648}
...
class QudaTwistDslashType(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'deg_twist_inv_dslash': 0, 'deg_dslash_twist_inv': 1, 'deg_dslash_twist_xpay': 2, 'nondeg_dslash': 3, 'dslash_invalid': -2147483648}
...
class QudaTwistCloverDslashType(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'deg_clover_twist_inv_dslash': 0, 'deg_dslash_clover_twist_inv': 1, 'deg_dslash_clover_twist_xpay': 2, 'tc_dslash_invalid': -2147483648}
...
class QudaSetupType(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'null_vector_setup': 0, 'test_vector_setup': 1, 'invalid_setup_type': -2147483648}
...
class QudaTransferType(Enum):
    ...
    _suffix = ""
    _values = {'aggregate': 0, 'coarse_kd': 1, 'optimized_kd': 2, 'optimized_kd_drop_long': 3, 'invalid': -2147483648}
...
class QudaFieldGeometry(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_geometry"
    _values = {'scalar': 1, 'vector': 4, 'tensor': 6, 'coarse': 8, 'kdinverse': 16, 'invalid': -2147483648}
...
class QudaContractGamma(Enum):
    ...
    _suffix = ""
    _values = {'i': 0, 'g1': 1, 'g2': 2, 'g3': 3, 'g4': 4, 'g5': 5, 'g1g5': 6, 'g2g5': 7, 'g3g5': 8, 'g4g5': 9, 's12': 10, 's13': 11, 's14': 12, 's21': 13, 's23': 14, 's34': 15, 'invalid': -2147483648}
...
class QudaGaugeSmearType(Enum):
    ...
    _suffix = ""
    _values = {'ape': 0, 'stout': 1, 'ovrimp_stout': 2, 'wilson_flow': 3, 'symanzik_flow': 4, 'invalid': -2147483648}
