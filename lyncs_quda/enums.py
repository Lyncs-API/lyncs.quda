...
class QudaInverterType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_inverter"
    _values = {'cg': 0, 'bicgstab': 1, 'gcr': 2, 'mr': 3, 'mpbicgstab': 4, 'sd': 5, 'xsd': 6, 'pcg': 7, 'mpcg': 8, 'eigcg': 9, 'inc_eigcg': 10, 'gmresdr': 11, 'gmresdr_proj': 12, 'gmresdr_sh': 13, 'fgmresdr': 14, 'mg': 15, 'bicgstabl': 16, 'cgne': 17, 'cgnr': 18, 'cg3': 19, 'cg3ne': 20, 'cg3nr': 21, 'ca_cg': 22, 'ca_cgne': 23, 'ca_cgnr': 24, 'ca_gcr': 25, 'invalid': -2147483648}
...
class QudaCloverFieldOrder(Enum):
    ...
    _values = {'float': 1, 'float2': 2, 'float4': 4, 'packed': 5, 'qdpjit': 6, 'bqcd': 7, 'invalid': -2147483648}
...
class QudaTwistFlavorType(Enum):
    ...
    _prefix = "quda_twist_"
    _suffix = ""
    _values = {'singlet': 1, 'nondeg_doublet': 2, 'deg_doublet': -2, 'no': 0, 'invalid': -2147483648}
...
class QudaTransferType(Enum):
    ...
    _suffix = ""
    _values = {'aggregate': 0, 'coarse_kd': 1, 'optimized_kd': 2, 'invalid': -2147483648}
...
class QudaFieldGeometry(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_geometry"
    _values = {'scalar': 1, 'vector': 4, 'tensor': 6, 'coarse': 8, 'invalid': -2147483648}
...
class QudaExtLibType(Enum):
    ...
    _prefix = "quda_"
    _suffix = ""
    _values = {'cusolve_extlib': 0, 'eigen_extlib': 1, 'magma_extlib': 2, 'extlib_invalid': -2147483648}
