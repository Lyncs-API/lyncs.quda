...
class QudaInverterType(Enum):
    ...
    _prefix = "quda_"
    _suffix = "_inverter"
    _values = {'cg': 0, 'bicgstab': 1, 'gcr': 2, 'mr': 3, 'mpbicgstab': 4, 'sd': 5, 'pcg': 6, 'mpcg': 7, 'eigcg': 8, 'inc_eigcg': 9, 'gmresdr': 10, 'gmresdr_proj': 11, 'gmresdr_sh': 12, 'fgmresdr': 13, 'mg': 14, 'bicgstabl': 15, 'cgne': 16, 'cgnr': 17, 'cg3': 18, 'cg3ne': 19, 'cg3nr': 20, 'ca_cg': 21, 'ca_cgne': 22, 'ca_cgnr': 23, 'ca_gcr': 24, 'invalid': -2147483648}
