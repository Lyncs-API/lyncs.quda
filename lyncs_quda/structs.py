...
class QudaGaugeSmearParam(Struct):
    ...
    _types = {'struct_size': 'size_t', 'n_steps': 'unsigned int', 'epsilon': 'double', 'alpha': 'double', 'rho': 'double', 'meas_interval': 'unsigned int', 'smear_type': 'QudaGaugeSmearType'}
...
class QudaBLASParam(Struct):
    ...
    _types = {'struct_size': 'size_t', 'blas_type': 'QudaBLASType', 'trans_a': 'QudaBLASOperation', 'trans_b': 'QudaBLASOperation', 'm': 'int', 'n': 'int', 'k': 'int', 'lda': 'int', 'ldb': 'int', 'ldc': 'int', 'a_offset': 'int', 'b_offset': 'int', 'c_offset': 'int', 'a_stride': 'int', 'b_stride': 'int', 'c_stride': 'int', 'alpha': 'double_complex', 'beta': 'double_complex', 'inv_mat_size': 'int', 'batch_count': 'int', 'data_type': 'QudaBLASDataType', 'data_order': 'QudaBLASDataOrder'}
