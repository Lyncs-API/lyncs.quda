...
class QudaGaugeParam(Struct):
    ...
    _types = {'location': 'QudaFieldLocation', 'X': 'int [ 4 ]', 'anisotropy': 'double', 'tadpole_coeff': 'double', 'scale': 'double', 'type': 'QudaLinkType', 'gauge_order': 'QudaGaugeFieldOrder', 't_boundary': 'QudaTboundary', 'cpu_prec': 'QudaPrecision', 'cuda_prec': 'QudaPrecision', 'reconstruct': 'QudaReconstructType', 'cuda_prec_sloppy': 'QudaPrecision', 'reconstruct_sloppy': 'QudaReconstructType', 'cuda_prec_refinement_sloppy': 'QudaPrecision', 'reconstruct_refinement_sloppy': 'QudaReconstructType', 'cuda_prec_precondition': 'QudaPrecision', 'reconstruct_precondition': 'QudaReconstructType', 'cuda_prec_eigensolver': 'QudaPrecision', 'reconstruct_eigensolver': 'QudaReconstructType', 'gauge_fix': 'QudaGaugeFixed', 'ga_pad': 'int', 'site_ga_pad': 'int', 'staple_pad': 'int', 'llfat_ga_pad': 'int', 'mom_ga_pad': 'int', 'staggered_phase_type': 'QudaStaggeredPhase', 'staggered_phase_applied': 'int', 'i_mu': 'double', 'overlap': 'int', 'overwrite_mom': 'int', 'use_resident_gauge': 'int', 'use_resident_mom': 'int', 'make_resident_gauge': 'int', 'make_resident_mom': 'int', 'return_result_gauge': 'int', 'return_result_mom': 'int', 'gauge_offset': 'size_t', 'mom_offset': 'size_t', 'site_size': 'size_t'}
...
class QudaGaugeObservableParam(Struct):
    ...
    _types = {'su_project': 'QudaBoolean', 'compute_plaquette': 'QudaBoolean', 'plaquette': 'double [ 3 ]', 'compute_qcharge': 'QudaBoolean', 'qcharge': 'double', 'energy': 'double [ 3 ]', 'compute_qcharge_density': 'QudaBoolean', 'qcharge_density': 'void *'}
...
class QudaBLASParam(Struct):
    ...
    _types = {'trans_a': 'QudaBLASOperation', 'trans_b': 'QudaBLASOperation', 'm': 'int', 'n': 'int', 'k': 'int', 'lda': 'int', 'ldb': 'int', 'ldc': 'int', 'a_offset': 'int', 'b_offset': 'int', 'c_offset': 'int', 'a_stride': 'int', 'b_stride': 'int', 'c_stride': 'int', 'alpha': 'double_complex', 'beta': 'double_complex', 'batch_count': 'int', 'data_type': 'QudaBLASDataType', 'data_order': 'QudaBLASDataOrder'}
